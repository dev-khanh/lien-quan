...
export function AccountCard({ account, priority = false }: AccountCardProps) {
  ...
  return (
    <article className={`overflow-hidden rounded-[22px] border bg-white shadow-[0_18px_46px_rgba(236,63,150,0.20)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_24px_58px_rgba(236,63,150,0.28)] ${renting || maintenance ? "border-white/40" : "border-[#ff5aa8]"}`}>
